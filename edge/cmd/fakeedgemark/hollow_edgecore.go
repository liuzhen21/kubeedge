...
import (
	...
	edged "github.com/kubeedge/kubeedge/edge/mocks/edged"
	"github.com/kubeedge/kubeedge/edge/pkg/common/dbm"
	edgehub "github.com/kubeedge/kubeedge/edge/pkg/edgehub"
...
func (c *hollowEdgeNodeConfig) addFlags(fs *pflag.FlagSet) {
	...
	fs.IntVar(&c.Count, "count", 1, "HTTPServer indicates the server for edge to apply for the certificate.")
...
func EdgeCoreConfig(config *hollowEdgeNodeConfig) *v1alpha2.EdgeCoreConfig {
	...
	edgeCoreConfig.Modules.Edged.Count = config.Count
	...
	edgeCoreConfig.Modules.EdgeHub.MessageBurst = 600
	...
	edgeCoreConfig.Modules.Edged.TailoredKubeletConfig.NodeLeaseDurationSeconds = 300
	edgeCoreConfig.Modules.Edged.TailoredKubeletConfig.NodeStatusUpdateFrequency.Duration = 300 * time.Second
	edgeCoreConfig.Modules.Edged.TailoredKubeletConfig.EnableDebugFlagsHandler = &falseFlag
	edgeCoreConfig.Modules.Edged.TailoredKubeletConfig.EnableDebuggingHandlers = &falseFlag
	edgeCoreConfig.Modules.Edged.TailoredKubeletFlag.RootDirectory = "/var/lib/edged"
